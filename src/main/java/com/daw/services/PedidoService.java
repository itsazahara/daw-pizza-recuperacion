...
public class PedidoService {
	...
	// R = Recoger
	// L = Local
	public List<Pedido> metodoDelivery (){
		return this.pedidoRepository.findByMetodo("D");
	}
	public List<Pedido> metodoRecoger (){
		return this.pedidoRepository.findByMetodo("R");
	}
	public List<Pedido> metodoLocal (){
		return this.pedidoRepository.findByMetodo("L");
	}
	
	public List<Pedido> pedidosHoy (){
		LocalDate ahora= LocalDate.now();
		LocalDateTime ayer = ahora.atStartOfDay();
		
		return this.pedidoRepository.findByFechaBetween(ayer,ahora );
	}
